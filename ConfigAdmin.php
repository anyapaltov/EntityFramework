    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">LAST TECHNOLOGY</small></h1>
            </div>
            <!-- Nav tabs -->
                                ...
                                <select class="form-control" name="prod-codigoP">
                                    <?php 
                                        ...
                                        while($provc=mysql_fetch_array($proveedoresc)){
                                            echo '<option value="'.$provc['ccProveedor'].'">'.$provc['NombreProveedor'].'</option>';
                                        }
                                    ?>
                                </select>
                              </div>
                                                  ...
                                                  <form method="post" action="process/updateProduct.php" id="res-update-product-'.$upr.'">
                                                    <tr>
                                                      ...
                                                      echo '</select>
                                                        ...
                                                        <td>';
                                                           $proveedoresc3=  ejecutarSQL::consultar("select * from proveedor where ccProveedor='".$prod['ccProveedor']."'");
                                                           while($provc3=mysql_fetch_array($proveedoresc3)){
                                                                    $nombreP=$provc3['NombreProveedor'];
                                                                    $ccP=$provc3['ccProveedor'];
                                                            }
                                                       echo '<select class="form-control" name="prod-Prove">';
                                                                echo '<option value="'.$ccP.'">'.$nombreP.'</option>';
                                                                $proveedoresc2=  ejecutarSQL::consultar("select * from proveedor");
                                                                while($provc2=mysql_fetch_array($proveedoresc2)){
                                                                    if($provc2['ccProveedor']==$ccP){
                                                                        
                                                                    }else{
                                                                      echo '<option value="'.$provc2['ccProveedor'].'">'.$provc2['NombreProveedor'].'</option>';
                                                                    }  
                                                                }  
                                                       echo '</select>
                                                        </td>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>cc</label>
                                    <input class="form-control" type="text" name="prove-cc" placeholder="cc proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
                        ...
                        <div id="del-prove">
                            ...
                            <form action="process/delprove.php" method="post" role="form">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="cc-prove">
                                        <?php 
                                            $provecc=  ejecutarSQL::consultar("select * from proveedor");
                                            while($PN=mysql_fetch_array($provecc)){
                                                echo '<option value="'.$PN['ccProveedor'].'">'.$PN['ccProveedor'].' - '.$PN['NombreProveedor'].'</option>';
                                            }
                                        ?>
                                    </select>
                                </div>
                                                  ...
                                                  echo '
                                                      <div id="update-proveedor">
                                                        <form method="post" action="process/updateProveedor.php" id="res-update-prove-'.$up.'">
                                                          <tr>
                                                              <td>
                                                                <input class="form-control" type="hidden" name="cc-prove-old" required="" value="'.$prov['ccProveedor'].'">
                                                                <input class="form-control" type="text" name="cc-prove" maxlength="30" required="" value="'.$prov['ccProveedor'].'">
                                                              </td>
                                                    ...
                                                    <div id="update-pedido">
                                                      <form method="post" action="process/updatePedido.php" id="res-update-pedido-'.$upp.'">
                                                        <tr>
                                                            ...
                                                            <td>'.$peU['Fecha'].'</td>
                                                            <td>';
                                                                $conUs= ejecutarSQL::consultar("select * from cliente where cc='".$peU['cc']."'");
