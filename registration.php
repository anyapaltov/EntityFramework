        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">Last Electronics</small></h1>
                </div>
                       ...
                       <form class="form-horizontal FormCatElec" action="process/regclien.php" role="form" method="post" data-form="save">
                           <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su número de CC" required name="clien-cc" data-toggle="tooltip" data-placement="top" title="Ingrese su número de CC. Solamente números" maxlength="30" pattern="[{1,30}">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
